    ...
    <div class="grid grid-cols-4 gap-4">
        <div class="col-span-3 bg-white rounded p-4">
             <h2 class="text-2xl font-bold mb-2">人気レシピ</h2>
                <div class="flex justify-between items-conter mb-6">
            @foreach($popular as $p)
                <a href={{ route('recipe.show', ['id'=> $recipe['id']]) }} class="max-h-12 rounded overflow-hidden shadow-lg mx-4">
                    <img class="max-h-52 h-52 w-full object-cover src="{{$p->image}}" alt="{{$p->title}}>
                    <div class="pxx-6 py-4">
